...
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file:///Users/kimlarocca/Websites/dearest-jack/node_modules/ufo/dist/index.mjs';
...
import { isVNode, toValue, isRef } from 'file:///Users/kimlarocca/Websites/dearest-jack/node_modules/vue/index.mjs';
...
import { createStorage, prefixStorage } from 'file:///Users/kimlarocca/Websites/dearest-jack/node_modules/unstorage/dist/index.mjs';
...
import consola, { consola as consola$1 } from 'file:///Users/kimlarocca/Websites/dearest-jack/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/kimlarocca/Websites/dearest-jack/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/kimlarocca/Websites/dearest-jack/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/kimlarocca/Websites/dearest-jack/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/kimlarocca/Websites/dearest-jack/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/kimlarocca/Websites/dearest-jack/node_modules/errx/dist/index.js';
...
const _w_u55VzNLO2T6USlnG_lP05sGKPDatc4frId10MlBq4 = (nitroApp) => {
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/kimlarocca/Websites/dearest-jack/.data/kv"}));
...
const plugins = [
  _w_u55VzNLO2T6USlnG_lP05sGKPDatc4frId10MlBq4,
_H4v4vF6m17cZ47UavggSjpERCHmFg0cxYR9GLjNEBo
];

const _lazy__S9JlX = () => Promise.resolve().then(function () { return renderer$1; });
...
const getClientManifest = () => import('file:///Users/kimlarocca/Websites/dearest-jack/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/kimlarocca/Websites/dearest-jack/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
